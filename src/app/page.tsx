      ...
      <section id="features" className="py-20 relative px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16 px-6">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight text-white uppercase italic">Todo lo que necesitas <br /><span className="text-primary not-italic">para escalar</span></h2>
            <p className="text-foreground/60 text-lg max-w-xl mx-auto italic">Configuración profesional en segundos, sin fricción.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="p-10 rounded-[2.5rem] bg-card/30 backdrop-blur-sm border border-border hover:border-primary/50 transition-all group relative overflow-hidden">
                ...
                <h3 className="text-2xl font-bold mb-4 group-hover:text-primary transition-colors uppercase tracking-tight italic">{f.title}</h3>
